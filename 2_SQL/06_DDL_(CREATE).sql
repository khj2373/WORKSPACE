...
오라클에서 객체(구조) : 테이블, 뷰, 시퀀스, 인덱스, 패키지, 트리거, 프로시져, 함수, 동의어, 사용자
...
INSERT INTO MEMBER
VALUES(1, 'USER1', 'PASS1', '홍길동', '나', '010-1111-2222', 'AAA@AAA.COM', '24/08/12');
...
INSERT INTO MEM_NOTNULL
VALUES(3, NULL, 'PASS3', '홍길삼', '남', '010-1111-2222', 'AAA@AAA.COM', '24/08/12');
...
INSERT INTO MEM_UNIQUE
VALUES(2, 'USER1', 'PASS2', '홍길순', '여', '010-2222-2222', 'BBB@BBB.COM', '24/08/12');
...
INSERT INTO MEM_UNIQUE
VALUES(NULL, 'USER4', 'PASS4', '홍길사', NULL, NULL, NULL, NULL);
...
--> 기본키에 NULL값을 담으려고 할 때(NOT NULL 제약조건 위반)
...
--복합키 : 두캐의 컬럼을 동시에 하나의 PRIMARY KEY로 지정하는 것

INSERT INTO MEM_PRI2
VALUES(1, 'USER1', 'PASS1', '홍길동', '남', NULL, NULL, NULL);

INSERT INTO MEM_PRI2
VALUES(1, 'USER2', 'PASS2', '홍길동', '남', NULL, NULL, NULL);

INSERT INTO MEM_PRI2
VALUES(2, 'USER3', 'PASS3', '홍길삼', '여', NULL, NULL, NULL);

INSERT INTO MEM_PRI2
VALUES(2, 'USER3', 'PASS4', '홍길사', '남', NULL, NULL, NULL);
...
INSERT INTO MEM
VALUES(3, 'USER3', 'PASS3', '홍길삼', '남', NULL, NULL, 20);

INSERT INTO MEM
VALUES(4, 'USER4', 'PASS4', '홍길사', '여', NULL, NULL, 30);

INSERT INTO MEM
VALUES(5, 'USER5', 'PASS5', '김현준', '남', NULL, NULL, 40);
--유효하지 않은 회원 등급 번호가 정상적으로 INSERT 되고 있다

----------------------------------------------------------------------------

/*
FOREIGN KEY(외래키) 재약조건
...
> 테이블레벨방식
FOREIGN(컬럼명) REFERENCES 참조할 테이블병[참조할컬럼명]

->참조할 컬럼명 생략시 테이블의 PRIMARY KEY로 지정된 컬럼이 매칭된다
*/
DROP TABLE MEM;
...
--부모 테이블로부터 무조건 삭제가 안되는 "삭제제한" 옵션이 걸려있다
...
INSERT INTO MEMBER VALUES(3, '김현준', 20, DEFAULT, DEFAULT);
