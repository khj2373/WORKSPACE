...
//		
//		//단순하게 origin을 다시 대입시킨 copy배열을 생성
//		int[] copy = origin;
//		
...
//		System.out.println();
		...
		//왜? origin관 copy가 같은 메모리를 참조하고 있기 때문(참조변수의 주소값이 동일)
		//얕은복사 : 주소값 복사
...
//		
//		//origin 배열에 있는 모들 값들을 copy 배열로 전달
//		for(int i=0; i<origin.length; i++) {
//			copy[i] = origin[i];
//		}
//		
...
//		int[] copy = new int[10];
		...
		//System.arraycopy(원본배열, 복사시작인덱스, 복사본배열, 복사본배열의시작인덱스, 복사할갯수)
