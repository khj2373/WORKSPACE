...
public class B_String {
	...
	public void method01() {
		...
		//주소값을 비교하기 때문에 false가 출력
		System.out.println(str1 == str2);
		
		//String 클래스에서 equals메소드는 이미 오버라이딩 되어 있음(주소값이 동일)
		...
		str3 = "bye";
		System.out.println(System.identityHashCode(str3));
		//변경하는 순간 기존 문자열 자리에서 변경되는게 아닌
		//새로운 곳을 참조하도록 함(새로운 주소값을 부여받음 == 주소값 변경)
	}
	...
	public void method02() {
		...
		System.out.println("str1d에 Hello라는 문자열이 포함? : " + str1.contains("Hello"));
		System.out.println("str1d에 Bye라는 문자열이 포함? : " + str1.contains("Bye"));
		...
		//문자열에서 oldChar문자를 char newChar로 변환한 채 문자열 리턴
		String str4 = str1.replace('l', 'c');
		System.out.println("str1 : " + str1);
		System.out.println("str4 : " + str4);
		
		//6. 문자열.toUpperCase() : String => 문자열을 전부 대문자로 변경해서 반환(소문자 변환은 toLowerCase)
		System.out.println(str1.toUpperCase());
		System.out.println(str1.toLowerCase());
		
		//7. 문자열.trim() : String
		//문자열의 앞 뒤 공간을 제거시킨 채 문자열 리턴
		String str5 ="    JA  va     ";
	...
	public void method03() {
		...
		//방법1. 분리된 문자열을 String[] 배열에 차곡차곡 담고자 할때
		...
		//hasMoreElements() -> 가져올 토큰이 남아있는지 확인해주는 메소드 남아있다면 true 없다면 false
