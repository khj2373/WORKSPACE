...
--1_2) 컬럼 수정(MODIFY)
--데이터 타입 수정 : MODIFY 컬럼명 바꾸고자 하는 데이터타입
...
--1_3) 컬럼삭제(DROP COLUMN) : DROP COLUMN 삭제하고자 하는 컬럼
...
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C007148 TO DTABLE_ID_NN;
