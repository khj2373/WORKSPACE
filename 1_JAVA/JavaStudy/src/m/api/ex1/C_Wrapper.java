...
public class C_Wrapper {
	...
	public void method01() {
		...
		System.out.println(i1.equals(i2)); //동등비교
		System.out.println(i1.compareTo(i2)); //대소비교
		
		//2. 객체생성을 하지 않고 곧바로 대입하는 방법(AutoBoxing)
		Integer i3 = num1;
		System.out.println(i3);
		
		//객체생성을 통해서 반드시 변환해야 하는 경우 -> 문자열을 Integer타입으로 변환하고 싶을 때
