/*
<JOIN>
두개 이상 테이블에세 데이터를 조회하고자 할 때 사용되는 구문
...
--2) RIGHT [OUTER] JOIN : 두 테이블 중 오른편에 기술 된 테이블들을 기준으로 JOIN
--ANSI 구문
SELECT EMP_NAME, DEPT_TITLE, SALARY, SALARY * 12
FROM EMPLOYEE
