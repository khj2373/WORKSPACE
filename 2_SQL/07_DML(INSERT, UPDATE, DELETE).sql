...
VALUES(900, '이소근', '880914-1456789', 'SG991@NAVAER.COM', '01012322222', 'D7', 'J5', 4000000, 0.2, 200, SYSDATE, NULL, 'N');
...
VALUES(901, '김현준', '000123-1234567', 'J7', SYSDATE);
...
[표현식]
DELETE FROM 테이블명
[WHERE 조건] -> WHERE 제시 안하면 전체행 다 삭제
*/
