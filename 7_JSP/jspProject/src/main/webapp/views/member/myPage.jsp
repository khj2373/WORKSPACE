        ...
        <form action="<%=contextPath %>/update.me" method="post" id="update-form">
            ...
            <script>
            	...
            	for(let input of inputArr){
            		if(interest.includes(input.value)){ //interest에 input.value값이 포함되어 있다면
            			input.checked = true;
            		}
            	}
            </script>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body" align="center">
					<form action="<%=contextPath%>/updatePwd.me" id="update-form" method="post">
					...
					<script>
						document.getElementById("edit-pwd-btn").onclick = function(){
				            const pwd = document.querySelector("#update-form input[name=updatePwd]").value
				            const pwdCheck = document.querySelector("#update-form input[name=checkPwd]").value
